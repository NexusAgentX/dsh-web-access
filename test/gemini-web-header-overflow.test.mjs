...
import { createGeminiFetch, GEMINI_MAX_HEADER_SIZE, resolveGeminiFetch } from "../src/gemini-web.ts";
...
test("resolveGeminiFetch surfaces dedicated agent construction errors", () => {
	...
	const script = [
		`import { resolveGeminiFetch } from ${JSON.stringify(new URL("../src/gemini-web.ts", import.meta.url).href)};`,
