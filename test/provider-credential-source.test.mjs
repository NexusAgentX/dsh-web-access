...
const geminiApiModuleUrl = new URL("../src/gemini-api.ts", import.meta.url).href;
...
const tinyfishModuleUrl = new URL("../src/tinyfish.ts", import.meta.url).href;
const perplexityModuleUrl = new URL("../src/perplexity.ts", import.meta.url).href;
