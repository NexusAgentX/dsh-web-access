...
const kagiModuleUrl = new URL("../src/kagi.ts", import.meta.url).href;
const bochaModuleUrl = new URL("../src/bocha.ts", import.meta.url).href;
const curatorPageModuleUrl = new URL("../src/curator-page.ts", import.meta.url).href;
const ollamaModuleUrl = new URL("../src/ollama.ts", import.meta.url).href;
const searchModuleUrl = new URL("../src/gemini-search.ts", import.meta.url).href;
const serpbaseModuleUrl = new URL("../src/serpbase.ts", import.meta.url).href;
...
test("Bocha search filters domains and closes activity on API errors", async () => {
	...
	const child = runChild(`
		...
		const { activityMonitor } = await import(new URL("../src/activity.ts", ${JSON.stringify(import.meta.url)}).href);
